...
export default function TournamentListings(){
    ...
    const [tournaments, setTournaments] = useState(
        [
        { id: 22, name:"USA States Cup", description:"States send their best players to compete in a 3v3 double elimination bracket, lorem ipsum awuiefha aewuifh aewf feuiohfa  fhuieohuifa feufiwoe", img:"https://gray-woio-prod.cdn.arcpublishing.com/resizer/7LTIJmffhz8U6XIFTa7g9WPwAuA=/1200x675/smart/filters:quality(85)/cloudfront-us-east-1.images.arcpublishing.com/gray/Q4C2SM42TJG7LGGJNLX5GF2NUE.png"},
        { id: 23, name:"VIRGINIA Regional CupVIRGINIA Regional CupVIRGINIA Regional CupVIRGINIA Regional Cup", description:"States send their best player in a 3v3 double elimination bracket, lorem ipsum awuiefha aewuifh aewf feuiohfa  fhuieohuifa feufiwoe"},
        { id: 35, name:"loomski", description:"States send their best players to compete in a 3v3 double elimination bracket, lorem ipsum fjsdfjs kjfkfsdjf ljsddf awuiefha aewuifh aewf feuiohfa  fhuieohuifa feufiwoe"},
